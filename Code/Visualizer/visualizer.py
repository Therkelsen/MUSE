...
def update_data(i):
    ...
    ax2.set_title('Filtered bioelectrical impedance modulus')
    ax2.grid(True)
    ...
    ax3.set_ylabel('Modulus of impedance |Ω|')
    ax3.set_title('Processed bioelectrical impedance modulus')
    ax3.grid(True)
    ...
    ax5 = plt.title('Magnitude Spectrum for FFT of filtered data')
    ax5 = plt.grid(True)
    ...
    ax6 = plt.title('Magnitude Spectrum for FFT of processed data')
    ax6 = plt.grid(True)
    ...
    ax8.set_title('Filtered bioelectrical impedance phase')
    ax8.grid(True)
    ...
    ax9.set_ylabel('Phase of impedance φ(Ω)')
    ax9.set_title('Processed bioelectrical impedance phase')
    ax9.grid(True)
    ...
    ax11 = plt.ylabel('Magnitude')
    ax11 = plt.title('Magnitude Spectrum for FFT of filtered data')
    ax11 = plt.grid(True)
    ...
    ax12 = plt.ylabel('Magnitude')
    ax12 = plt.title('Magnitude Spectrum for FFT of processed data')
    ax12 = plt.grid(True)
