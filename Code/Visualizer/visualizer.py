...
def update_data(i):
    ...
    modulus_processed_data = load_data("Code/Data/MoCap/static/1_0kg_180deg_reg/filtered_output_data.csv", 1)
    modulus_filtered_data = load_data("Code/Data/MoCap/static/1_0kg_180deg_reg/processed_output_data.csv", 1)
