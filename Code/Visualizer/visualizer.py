...
def update_data(i):
    ...
    modulus_filtered_data = load_data("Code/GRU_network/MoCap/dynamic/85_FRMJ_6kg_reg/processed_output_data.csv", 1)
    modulus_processed_data = load_data("Code/GRU_network/MoCap/dynamic/85_FRMJ_6kg_reg/filtered_output_data.csv", 1)
    ...
    phase_processed_data = load_data("Code/GRU_network/MoCap/dynamic/85_FRMJ_6kg_reg/filtered_output_data.csv", 2)
    phase_filtered_data = load_data("Code/GRU_network/MoCap/dynamic/85_FRMJ_6kg_reg/processed_output_data.csv", 2)
